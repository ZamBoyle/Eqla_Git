...
- [40. Les GitHub Pages](#40-les-github-pages)
  - [40.1 Créons le dépôt sur le site GitHub](#401-créons-le-dépôt-sur-le-site-github)
    - [A. Via le site GitHub](#a-via-le-site-github)
    - [B. Via gh](#b-via-gh)
  - [40.2 Créons un dépôt local et poussons-le sur GitHub:](#402-créons-un-dépôt-local-et-poussons-le-sur-github)
- [41. Jekyll et GitHub Pages](#41-jekyll-et-github-pages)
...
Les GitHub Pages sont des pages web hébergées sur GitHub. Elles sont accessibles via l'url suivante: https://johndoe.github.io.

Pour créer une GitHub Page, il faut créer un dépôt public et le nommer: votreNomUtilisateur.github.io

Ensuite, vous pouvez créer un fichier index.html et le pousser sur GitHub. Vous pourrez alors accéder à votre page via l'url: https://johndoe.github.io ou bien-entendu via l'url du fichier index.html: https://johndoe.github.io/index.html
...
### 40.1 Créons le dépôt sur le site GitHub

#### A. Via le site GitHub
1. Allez sur cette page:[Create a new repository](https://github.com/new)
2. Dans le champ Repository name, mettez: johndoe.github.io remplacez johndoe par votre nom d'utilisateur GitHub.
3. Cliquer sur le bouton vert: Create repository.

#### B. Via gh
1. `gh repo create johndoe.github.io --public` remplacez johndoe par votre nom d'utilisateur GitHub.

### 40.2 Créons un dépôt local et poussons-le sur GitHub:
Dans l'exemple suivant, remplacez johndoe par votre nom d'utilisateur GitHub.
```bash
cd mesdepots
mkdir johndoe.github.io 
...
git push -u origin master
```
Allez sur votre page: https://johndoe.github.io

Vous devriez voir votre page.

Donc je rappelle que vous devez créez un dépôt public et le nommer: votreNomUtilisateur.github.io

**__Exemples__**:
| nom d'utilisateur | dépôt à créer | URL GitHub Pages |
|-------------------|-------|-----|
|carmentod | carmentod.github.io | https://carmentod.github.io |
|anthonyvelez1819 | anthonyvelez1819.github.io | https://anthonyvelez1819.github.io |
| thardui | thardui.github.io | https://thardui.github.io |
| filydev | filydev.github.io | https://filydev.github.io |
| amir-eqla | amir-eqla.github.io | https://amir-eqla.github.io |
| karimuchiwa | karimuchiwa.github.io | https://karimuchiwa.github.io |
| baptistebrasseur | BaptisteBrasseur.github.io | https://BaptisteBrasseur.github.io |
| chrishonore | chrishonore.github.io | https://chrishonore.github.io |

PS: N'oubliez pas qu'il est possible que master ne soit pas la branche par défaut. Dans ce cas, il faudra remplacer master par le nom de votre branche par défaut qui sera souvent main.

## 41. Jekyll et GitHub Pages

Jekyll est un générateur de sites statiques. Cela signifie qu'il prend du contenu brut, comme des fichiers Markdown, et les transforme en un site web complet sans nécessiter de base de données. Le contenu statique est rapide, sécurisé et facile à héberger.

Parler de Jekyll et de GitHub Pages est un peu hors sujet pour ce cours. Je vous en parle car GitHub Pages peut utiliser Jekyll pour générer les pages web. Mais c'est nullement nécessaire. Vous pouvez très bien créer votre page web en HTML, CSS et JavaScript et la pousser sur GitHub Pages: Et voilà, vous avez votre site web.

Cela peut éventuellement vous être utile plus tard mais ce n'est pas le but de ce cours. De plus, le scaffolding de Jekyll n'est pas très clair pour un débutant.

Le terme scaffolding peut sembler barbare mais c'est un terme utilisé en informatique pour désigner la création d'un squelette de projet. C'est-à-dire que Jekyll va créer une structure de fichiers et de dossiers pour vous aider à démarrer votre projet.

Je vous ai mis un lien vers la documentation de Jekyll si vous voulez en savoir plus: [Jekyll](https://jekyllrb.com/docs/)

Ainsi que la documentation de Jekyll sur GitHub Pages: [Jekyll on GitHub Pages](https://docs.github.com/en/pages/setting-up-a-github-pages-site-with-jekyll/about-github-pages-and-jekyll)

Une vidéo de 15 minutes sur Jekyll: [Getting Started With Jekyll, The Static Site Generator](https://www.youtube.com/watch?v=iWowJBRMtpc) mais évidemment, c'est en anglais.
