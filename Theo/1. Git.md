...
- [28B. Token de connexion](#28b-token-de-connexion)
  - [28B.1 Création du token](#28b1-création-du-token)
  - [28B.2 Enregistrer le token globalement](#28b2-enregistrer-le-token-globalement)
  - [28B.3 désenregistrer le token globalement](#28b3-désenregistrer-le-token-globalement)
...
- [36. Ajouter un dépôt local sur GitHub](#36-ajouter-un-dépôt-local-sur-github)
  - [36.1 Via Git](#361-via-git)
  - [36.2 Via Git](#362-via-git)
- [37. Les branches dans Git](#37-les-branches-dans-git)
...
3. Tapez la commande gh gist create VotreFichier.html -d "Ceci est mon premier gist" -p  
   Le paramètre VotreFichier.html signifie que vous devez indiquer un nom de fichier. Ne mettez pas les < >
...
## 36. Ajouter un dépôt local sur GitHub

### 36.1 Via Git

### 36.2 Via Git

## 37. Les branches dans Git
