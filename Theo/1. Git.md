...
1. **Créez un nouveau dépôt sur GitHub**. Assurez-vous de ne pas initialiser ce dépôt avec un README, .gitignore ou une licence pour le moment.
...
1. Créez un nouveau dépôt sur `GitHub` qui porte le nom `DemoPushLocal`. Assurez-vous de ne pas initialiser ce dépôt avec un `README`, `.gitignore` ou une `licence` pour le moment.
...
10. Ajoutez l'URL du dépôt distant (remplacer votreNomUtilisateur par votre nom d'utilisateur GitHub): `git remote add origin https://github.com/votreNomUtilisateur/DemoPushLocal.git` 
...
### 40.1 Créons un dépôt local et poussons-le sur GitHub:
```bash
...
### 40.2 Poussons un dépôt existant depuis la ligne de commande:
```bash
git remote add origin https://github.com/kikinorev/github.io.git
git push -u origin master
```
...
4. Allez dans ce répertoire: `cd votreNomUtilisateur.github.io`
5. Clonez votre dépôt: git clone https://github.com/votreNomUtilisateur/zamboyle.github.io
6. Créez un fichier index.html
6. Ajoutez le code suivant dans votre fichier index.html:
```html
<!DOCTYPE html>
<html lang="fr-BE">
<head>
...
```
7. Indexez votre fichier: `git add index.html`
8. Commitez votre fichier: `git commit -m "Ajout de mon fichier index.html"`
9. Poussez votre fichier index.html sur GitHub: `git push -u origin master`
10. Allez sur votre page: https://votreNomUtilisateur.github.io
