...
![Logo Eqla](https://raw.githubusercontent.com/ZamBoyle/Eqla_Git/master/media/eqla.png)
...
- [5. Utiliser la ligne de commandes/du terminal](#5-utiliser-la-ligne-de-commandesdu-terminal)
- [6.	Qu’est-ce un dépôt/repository Git ?](#6quest-ce-un-dépôtrepository-git-)
- [7.	Répertoire courant vs la zone d’indexation vs dépôt](#7répertoire-courant-vs-la-zone-dindexation-vs-dépôt)
...
- [15. Modifications d'un fichier](#15-modifications-dun-fichier)
  - [Première modification](#première-modification)
  - [Deuxième modification](#deuxième-modification)
  - [Troisième modification](#troisième-modification)
...
- [20. GitHub](#20-github)
- [21. clone un dépôt hébergé sur GitHub avec la commande git clone](#21-clone-un-dépôt-hébergé-sur-github-avec-la-commande-git-clone)
...
- [26. clone un dépôt hébergé sur GitHub avec la commande gh repo clone](#26-clone-un-dépôt-hébergé-sur-github-avec-la-commande-gh-repo-clone)
...
- [33. Git stash: garder des modifications non commitées](#33-git-stash-garder-des-modifications-non-commitées)
...
## 1. Introduction
Nous allons illustrer l'utilité de Git dans la pratique de votre métier via trois exemples:
...
Auparavant, les développeurs utilisaient Bitkeeper de la société Bitmover qui concédait une licence gratuite d'utilisation au développement du noyau Linux. Mais un développeur du Noyau commença a créé un client opensource pour accéder à Bitkeeper. Ce qui provoqua après de longues négociations la suppression de la licence gratuite aux développeurs du noyau Linux. Réaction que l'on peut comprendre dans l'absolu... C'est pourquoi Linus Torvalds coda Git pour éviter tout futurs problèmes de licence d'utilisation. Ce qui devait sans doute arriver tôt ou tard car car les puristes du logiciel libres dont le grand gourou du logiciel libre Richard Stallman prônait depuis longtemps qu'il n'était pas acceptable que le noyau Linux utilise un logiciel propriétaire pour la gestion de son code source.
...
## 5. Utiliser la ligne de commandes/du terminal
...
Copiez le fichier genius.js dans le répertoire cours_git

## 13. Indexer/désindexer ses modifications
Pour indexer un fichier on utilise la commande git add
1. git status  (qu'est-ce qui a changé ?) On voit qu'il est indiqué untracked files. Il y est indiqué notre fichier genius.js
...
1. git reset genius.js (on a retiré les modifications de la zone d'index)
2. git status

## 14. Notre premier commit
1. git commit -m "Ajout du fichier genius.js"
...
## 21. clone un dépôt hébergé sur GitHub avec la commande git clone
...
## 26. clone un dépôt hébergé sur GitHub avec la commande gh repo clone
...
## 33. Git stash: garder des modifications non commitées
